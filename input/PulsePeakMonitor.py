#!/usr/bin/env python
# Original source code: http://freshfoo.com/blog/pulseaudio_monitoring
...
class PulsePeakMonitor(object):
    ...
    def __init__(self, sink_name, rate):
        ...
        context = pa_context_new(_mainloop_api, 'dmx-light-tools')
    ...
    def stop(self):
        if self.verbose:
            print 'TODO: properly close the session'
        self.run = False
    ...
    def sink_info_cb(self, context, sink_info_p, _, __):
        ...
        if sink_info.name == self.sink_name:
            ...
            pa_stream = pa_stream_new(context, "peak detect", samplespec, None)
...
def main():
    monitor = PulsePeakMonitor(SINK_NAME, METER_RATE)
